...
const botService_1 = require("./botService"); // Importa a lógica principal do bot
const api_client_1 = require("./api-client"); // Importa o objeto api refatorado
/**
...
const client = new whatsapp_web_js_1.Client({
    authStrategy: new whatsapp_web_js_1.LocalAuth({ clientId: 'agendamento_barber_bot' }),
});
...
client.on('ready', async () => {
    ...
    await api_client_1.api.loginProfissional('camilo@gmail.com', '123456');
});
/**
...
client.on('message_create', async (msg) => {
    ...
    if (!mensagem || msg.hasMedia)
        return;
    console.log(`\n<- [${telefone}] Recebido: ${mensagem}`);
    try {
        // Chama a lógica principal do bot, que gerencia o estado da conversa e a API.
        const botResponse = await (0, botService_1.handleIncomingMessage)(telefone, mensagem);
        if (botResponse) {
